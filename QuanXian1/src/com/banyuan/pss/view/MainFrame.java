...
public class MainFrame extends JFrame {
	...
	private String f;
	public MainFrame(String f, String d) {
		this.f=f;
		setResizable(false);
		setTitle("小型超市管理系统");
...
//		});
		...
		btnUserMGT = new JButton("用户管理");
		btnUserMGT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				UserManagerFrame a = UserManagerFrame.getInstance();
				a.setVisible(true);
			}
		});
		...
		btnChangePwd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ChangePwdFrame b=ChangePwdFrame.getInstance();
				b.setC(f);
				b.setVisible(true);
			}
		});
		...
		btnAuthorityMGT = new JButton("权限管理");
		btnAuthorityMGT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ChangeRight c = ChangeRight.getInstance();
				c.setVisible(true);
			}
		});
